...
The shipped copy also has small-size derivatives — `icon-16.png`, `icon-32.png`, `icon-180.png`
(apple-touch-icon) — sharpened+resized from this same art so the browser tab renders a legible
